...
import com.github.yjz.wrap_retrofit.http.factory.ApiResultConverterFactory
...
class MyApiResultConverterFactory(gson: Gson) : ApiResultConverterFactory(gson) {
    ...
    override fun unwrapResponse(
        ...
        try {
            ...
            //{"ErrNum":"1","ErrMsg":"用户名或密码错误","RowCount":"","TotolCount":"","Value":""}
